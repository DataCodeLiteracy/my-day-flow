            ...
            <div className='overflow-x-auto'>
              <div className='min-w-[400px]'>
                ...
                <div className='flex gap-2 py-2 px-3 text-xs font-medium text-theme-tertiary border-b border-theme-primary/20 mb-2'>
                  ...
                  <div className='w-20 flex-shrink-0 text-center'>집중시간</div>
                  <div className='w-12 flex-shrink-0 text-center'>일시정지</div>
                ...
                {allSessions
                  .map((session) => {
                    ...
                    return segments.map((segment, segmentIndex) => {
                      const startTimeStr = segment.startTime.toLocaleTimeString(
                        "ko-KR",
                        {
                          hour: "2-digit",
                          minute: "2-digit",
              ...
              <div className='space-y-4'>
                ...
                <div>
                  ...
                  <select
                    ...
                    className='w-full px-3 py-2 border border-theme-primary/20 rounded-lg bg-theme-background text-theme-primary focus:outline-none focus:border-theme-primary disabled:bg-gray-100'
                  >
